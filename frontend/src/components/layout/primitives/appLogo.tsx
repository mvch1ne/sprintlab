    ...
    <HoverCard openDelay={100} closeDelay={200}>
      <HoverCardTrigger asChild>
        <button className="flex items-center gap-2 cursor-pointer group">
          ...
          />
          <span className="text-[12px] uppercase tracking-[0.2em] text-zinc-700 dark:text-zinc-300 dark:bg-zinc-950 group-hover:text-zinc-700 dark:group-hover:text-zinc-300 transition-colors font-sans">
            SprintLab
          </span>
        </button>
      </HoverCardTrigger>
